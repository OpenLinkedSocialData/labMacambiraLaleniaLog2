...
a=S.irc.publishLog("../data/irc/labmacambira_lalenia2.txt",fpath,"labMacambiraLaleniaLog2",scriptpath,datetime.date(2013, 10, 15))
b=S.irc.publishLog("../data/irc/labmacambira_lalenia3.txt",fpath,"labMacambiraLaleniaLog3",scriptpath,datetime.date(2015, 9, 15))
